...
def admin_or_maintenance_person(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    actual_decorator = user_passes_test(
            lambda u: u.is_active and (u.is_maintenance_person or u.is_staff),
            login_url=login_url,
            redirect_field_name=redirect_field_name
    )
    if function:
...
def non_admin_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    actual_decorator = user_passes_test(
