...
urlpatterns = [
    ...
    path("delete-route/<int:pk>", views.delete_route, name="delete-route"),
    ...
    path("fuel_reports_list/", views.list_fueling_reports, name="fueling-reports-list"),
    path("fuel_tasks_list/", views.list_fueling_tasks, name="fueling-tasks-list"),
    path("fuel_task/", views.create_fueling_task, name="create-fueling-task"),
    path("update_fuel_task/<int:pk>", views.update_fueling_task, name="update-fueling-task"),
